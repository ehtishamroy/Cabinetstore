...
<div class="p-6 sm:p-8">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Edit Door Color</h1>
        <p class="text-gray-600 mt-1">Update the door color information.</p>
    </div>

    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <form action="{{ route('admin.door-colors.update', $doorColor) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                
                <div class="mb-4">
                    <label for="name" class="block text-sm font-medium text-gray-700">Door Color Name</label>
                    <input type="text" name="name" id="name" value="{{ old('name', $doorColor->name) }}" 
